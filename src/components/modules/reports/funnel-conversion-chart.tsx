...
export function FunnelConversionChart({
  ...
  return (
    <WidgetCard size="sm" title="Pipeline Funnel" accent="indigo" icon={Filter}>
        ...
        {data.map((stage, i) => {
          ...
          return (
            <div key={stage.status}>
              {i > 0 && (
                <div className="mb-1 flex items-center gap-1.5 pl-1 text-[11px] text-muted-foreground">
                  <span
                    className={
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="h-5 flex-1 overflow-hidden rounded-md bg-muted">
                  <div
                    className={`flex h-full items-center justify-end rounded-md px-2 text-[11px] font-medium text-white transition-[width] ${ACCENT_FILL[LEAD_STATUS_ACCENT[stage.status]]}`}
